...
namespace sparky
{
	...
	//
	class JointAngleController: public ServoAngleController
	{
		public:
...
operator >>( const YAML::Node &nodes,
             pololu::maestro::JointAngleController &joint_angle_controller );
void operator >>( const YAML::Node &node,
                  pololu::maestro::JointAngleLimits &joint_angle_limits );
void operator >>( const YAML::Node &node,
                  pololu::maestro::JointAnglePair &joint_angle_pair );
