/*!@file Envision/env_log.c Interface to syslog */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Envision/env_log.c $
...
// ######################################################################
void env_assert(const char* what, int custom_msg,
                const char* where, int line_no)
{
        (*g_assert_handler)(what, custom_msg, where, line_no);
}
